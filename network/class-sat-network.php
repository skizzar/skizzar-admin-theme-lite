...
class Skizzar_Admin_Theme {
    ...
    static function action_image_block() {
        ...
        $background_image = (Skizzar_Admin_Theme_Options::get_saved_network_option( 'banner-image' )) ? Skizzar_Admin_Theme_Options::get_saved_network_option( 'banner-image' ) : '';
	...
	static function action_remove_version_header( $errors ) {
		...
		if ( Skizzar_Admin_Theme_Options::get_saved_network_option( 'remove-version-header' ) ) {
	...
	static function action_inject_custom_site_css_header() {
		...
		if ( ! Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-site-css' ) ) {
			return;
		}

		// Output CSS
		echo '<style type="text/css" class="sat-custom-css">';
			echo Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-site-css' );
		echo '</style>';
	...
	static function action_inject_custom_site_js_header() {
		...
		if ( ! Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-site-js-header' ) ) {
			return;
		}

		// Output JS
		echo '<script type="text/javascript" class="sat-custom-js">';
			echo Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-site-js-header' );
		echo '</script>';
	...
	static function action_inject_custom_site_js_footer() {
		...
		// Only if custom JS is supplied
		if ( ! Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-site-js-footer' ) ) {
			return;
		}

		// Output JS
		echo '<script type="text/javascript" class="sat-custom-js">';
			echo Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-site-js-footer' );
		echo '</script>';
	...
	static function action_inject_custom_admin_css_header() {
		...
		// Only if custom CSS is supplied
		if ( ! Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-admin-css' ) ) {
			return;
		}

		// Output CSS
		echo '<style class="sat-custom-css">';
			echo Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-admin-css' );
		echo '</style>';
	...
	static function action_inject_custom_admin_js_header() {
		...
		// Only if custom JS is supplied
		if ( ! Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-admin-js-header' ) ) {
			return;
		}

		// Output JS
		echo '<script class="sat-custom-js">';
			echo Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-admin-js-header' );
		echo '</script>';
	...
	static function action_inject_custom_admin_js_footer() {
		...
		// Only if custom JS is supplied
		if ( ! Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-admin-js-footer' ) ) {
			return;
		}

		// Output JS
		echo '<script class="sat-custom-js">';
			echo Skizzar_Admin_Theme_Options::get_saved_network_option( 'custom-admin-js-footer' );
		echo '</script>';
	...
	static function is_themed() {
		...
		if ( in_array( $GLOBALS['pagenow'], array( 'wp-login.php', 'wp-register.php' ) ) && Skizzar_Admin_Theme_Options::get_saved_network_option( 'enable-login-theme' ) ) {
			return true;
		}

		// Admin area
		if ( is_admin() && Skizzar_Admin_Theme_Options::get_saved_network_option( 'enable-admin-theme' ) ) {
			return true;
		}

		// Viewing site
		if ( Skizzar_Admin_Theme_Options::get_saved_network_option( 'enable-site-toolbar-theme' ) ) {
			return true;
		}
